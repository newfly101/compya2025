...
-- =====================================================================
-- /* v2 기준 플레이어카드 */  2026-09-02 비활성화
--
-- DDL 만 있고 적재된 데이터가 없어 DROP 대상으로 확정했다.
-- 실제 DROP 문 : sql/cleanup/drop_player_card_v1_v2.sql
-- 대응 Java   : domain/fun/playerCard/** (전량 주석 처리)
--
-- 레전드 스탯을 신규 신설(data_player_legend_stat)로 먼저 쌓고,
-- 컨텐츠가 확정되면 이 구조로 통합 + 데이터 이관할 때 복원한다.
-- =====================================================================
