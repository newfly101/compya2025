  ...
  },
  {
    ...
    body: (
      <>
        ...
        <p className={styles.p}>
          회원 탈퇴는 로그인 후 마이페이지에서 직접 하실 수 있습니다. 탈퇴하면
          계정은 즉시 이용할 수 없게 되며, 보관 기간인 {RETENTION_PERIOD} 안에
          다시 네이버 계정으로 로그인하면 계정이 복구됩니다. 보관 기간이 지나면
          파기되어 복구할 수 없습니다.
        </p>
        <p className={styles.p}>
          탈퇴 처리에 문제가 있거나 즉시 파기를 원하시는 경우 아래{" "}
