    ...
    children: [
      {
        ...
        children: [
          ...
          { path: ROUTE_PATHS.admin_notice_write, element: <AdminNoticeWritePage />, handle: ROUTE_META.ADMIN_NOTICE_WRITE },
          { path: ROUTE_PATHS.admin_notice_write_edit_pattern, element: <AdminNoticeWritePage />, handle: ROUTE_META.ADMIN_NOTICE_WRITE },
          { path: ROUTE_PATHS.admin_tab_pattern, element: <AdminShellPage />, handle: ROUTE_META.ADMIN },
        ],
      },
    ],
  },
