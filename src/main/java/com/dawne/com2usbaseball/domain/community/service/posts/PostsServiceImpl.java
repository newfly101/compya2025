...
public class PostsServiceImpl implements PostsService {
    ...
    public ListResponse<PostResponse> selectAllPostLists() {
        List<PostsEntity> posts = repository.selectPostItems();

        return ListAssembler.assemble(posts, PostResponse::from);
    }
    ...
    public ListResponse<PostResponse> selectPostListsByBoard(Long boardId) throws NotFoundException {
        ...
        List<PostsEntity> posts = repository.selectUserPostByBoardId(boardId);
